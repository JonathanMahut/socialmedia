...
class _FlashesPageState extends State<FlashesPage> {
      ...
      if (flashData.isNotEmpty) {
        for (int i = 0; i < flashData.length; i++) {
          _swipeItems.add(SwipeItem(
              ...
              content: Content(text: flashData[i]['name']['first']),
              likeAction: () {
              ...
              nopeAction: () {
                _scaffoldKey.currentState?.showSnackBar(SnackBar(
                  content: Text("Nope ${flashData[i]['name']['first']}"),
                  duration: const Duration(milliseconds: 500),
                ));
              },
              superlikeAction: () {
                _scaffoldKey.currentState?.showSnackBar(SnackBar(
                  content: Text("Superliked ${flashData[i]['name']['first']}"),
                  duration: const Duration(milliseconds: 500),
                ));
              },
