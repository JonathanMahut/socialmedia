...
class _ArtistHomeScreenState extends State<ArtistHomeScreen> with AutomaticKeepAliveClientMixin {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const StoryWidget(),
              // Section to showcase artist's work
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Implement a grid or carousel to display tattoo designs
                    // You can fetch designs from Firestore or use local assets
                    ...
                    GridView.builder(
                      ...
                      itemCount: 6, // Replace with the actual number of designs
                      itemBuilder: (context, index) {
                        return Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(8),
                            image: const DecorationImage(
                              image: AssetImage('assets/placeholder_tattoo.jpg'), // Replace with actual image
                              fit: BoxFit.cover,
                            ),
                          ),
                        );
              ...
              // Section for booking options or other artist-specific features
              Padding(
                padding: const EdgeInsets.all(16.0),
                child: ElevatedButton(
                  onPressed: () {
                    // Implement navigation to booking screen or other features
                  },
